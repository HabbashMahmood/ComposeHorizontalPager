package com.habbashmahmood.compose_horizontal_pager.ui.theme
...
val dark_secondary = Color(0xFFFFA000)
val dark_onSecondary = Color(0xFFFFFFFF)

val black54 = Color(0x8A000000)
val textColor2 = Color(0xFF787a6d)
val mainColor = Color(0xFF92A3FD)
